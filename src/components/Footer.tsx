      ...
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold mb-4">UMKMForecast Jabar</h3>
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a
                href="https://www.instagram.com/supra.y1/"
                target="_blank"
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2 text-blue-100">
              ...
              <li>Dinas Koperasi dan UMKM</li>
              <li>Kementerian UMKM RI</li>
            </ul>
          </div>

          <div className="text-center md:text-right">
            <h3 className="text-lg font-semibold mb-4">Hubungi Kami</h3>
            <p className="text-blue-100 mb-2">developer@gmail.com</p>
            <p className="text-blue-100">Jl. Banjar No. 35, Panatasan</p>
          </div>
        </div>

        <div className="mt-8 pt-6 border-t border-blue-700 text-center text-blue-200">
          <p>
            © {new Date().getFullYear()} UMKMForecast Jabar - Solusi Cerdas
            Prediksi UMKM Jawa Barat
          </p>
        </div>
      </div>
    </footer>
